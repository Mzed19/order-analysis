    ...
    <div className="document-list-page animate-fade-in">
      <div className="page-header">
        <div className="header-title">
          <h1>Análise de Pedidos de Compra</h1>
          <p className="subtitle">Acompanhe a análise de crédito de seus pedidos</p>
          ...
          <div className="retention-warning">
            ...
            Tempo de resposta lento, estou hosteando do notebook local.
          </div>
        </div>
      ...
      <div className="table-container ">
        {documents.length > 0 ? (
          ...
          <div className="analysis-placeholder" style={{ padding: '80px 20px' }}>
            ...
            <p>Comece fazendo o upload de um pedido de compra para análise de crédito.</p>
